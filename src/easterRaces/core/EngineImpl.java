...
public class EngineImpl implements Engine {
    ...
    private String processInput() throws IOException {
        ...
        String result = switch (command) {
            case AddDriverToRace -> this.addDriver(data);
            case End -> Command.End.name();
            case StartRace -> this.startRace(data);
            case CreateDriver -> this.createDriver(data);
            case AddCarToDriver -> this.addCar(data);
            case CreateCar -> this.createCar(data);
            case CreateRace -> this.createRace(data);
            default -> null;
        };
